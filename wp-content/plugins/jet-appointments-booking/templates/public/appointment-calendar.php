...
<div class="jet-apb-calendar-wrapper">
	...
	<div class="jet-apb-calendar-appointments-list-wrapper" style="display: none">
		<div class="<?php echo $this->scopeClass( '__heading' ) ?>">
			<span class="<?php echo $this->scopeClass( '__label-text' ) ?>"><?php echo JET_APB\Plugin::instance()->settings->get_custom_label( 'appointmentDetails', esc_html__( 'Appointment details:', 'jet-appointments-booking' ) ); ?></span>
		</div>
