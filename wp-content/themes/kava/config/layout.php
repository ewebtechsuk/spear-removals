...
// Note: this file is procedural configuration. To avoid deprecated dynamic property
// warnings when Kava_Theme_Setup assigns ->layout, ensure the class itself declares
// the property or uses #[\AllowDynamicProperties].
